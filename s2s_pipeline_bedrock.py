...
from arguments_classes.bedrock_language_model_arguments import BedrockLanguageModelHandlerArguments
...
def main():
    parser = HfArgumentParser(
        (
            ...
            BedrockLanguageModelHandlerArguments,
            MLXLanguageModelHandlerArguments,
    ...
    if len(sys.argv) == 2 and sys.argv[1].endswith(".json"):
        ...
        (
            ...
            bedrock_language_model_handler_kwargs,
    ...
    prepare_args(bedrock_language_model_handler_kwargs, "bedrock")
    ...
    elif module_kwargs.llm == "bedrock":
        from LLM.bedrock_language_model import BedrockModelHandler

        lm = BedrockModelHandler(
            stop_event,
            queue_in=text_prompt_queue,
            queue_out=lm_response_queue,
            setup_kwargs=vars(bedrock_language_model_handler_kwargs),
        )
